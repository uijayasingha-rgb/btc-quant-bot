...
def fetch_crypto_quant_data(symbol="BTCUSDT", interval="5m", limit=300):
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if data and len(data) > 0:
                ...
                df = df.rename(columns={'taker_buy_base_asset_volume': 'taker_buy_base_vol'})
...
def train_5m_quant_model():
    ...
    while True:
        attempts += 1
        raw_df = fetch_crypto_quant_data(symbol="BTCUSDT", interval="5m", limit=300)
